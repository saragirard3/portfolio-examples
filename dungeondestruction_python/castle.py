...
strength_character = None
magic_character = None
dexterity_character = None
life_character = None

cls()
print('Castle Dungeon - An interactive fiction game in Python')
...
def Intro():
    ...
    An evil sorcerer is holding your fellow adventurers prisoner.
    Will you succeed to free your friends from the castle?
