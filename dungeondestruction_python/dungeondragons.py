...
def scene_14():
	...
	while choice is None:
		...
		This room is round, filled with gold and jewels.

		There are four doors evenly spaced around the room.

		Directly in front of the party there is a stand with a note on it.

		"""+party[pdr_2]['name']+""" reads the note....

		YOU HAVE MADE IT SO FAR, BUT THE HARDEST PART IS YET TO COME.
		THERE ARE FOUR DOORS WITH MY MANY GIFTS. GO INSIDE AND ACCEPT WHAT I HAVE TO OFFER.

		MY ONLY WARNING IS TO NOT TOUCH THE BOTTLE IN THE CENTER.

		I KNOW IT'S SHINY, BUT YOU WILL WANT TO WAIT.
		...
		"""+party[pdr_1]['name']+""", what do you decide to do?

		1 - Go to door 1
		2 - Go to door 2
		3 - Go to door 3
		4 - Go to door 4
		5 - haha...shiney bottle
		""")
...
def scene_18():
	...
	print("""
	"""+party[pdr_1]['name']+""" and """+party[pdr_2]['name']+""" try to get the debris out of the way.

	Every time they move a little, a lot more falls in it's place.
...
def closet_1():
	...
	input("""
	This room is plain and small. The party can barely fit in it.

	At the back of the room, a chest sits.

	"""+party[pdr_1]['name']+""" walks to the chest and opens it up.

	Inside there is a note and viles.

	"""+party[pdr_2]['name']+""" reads the note:

	YOU HAVE GOTTEN FAR BUT WILL NEED THIS GIFT TO LEAVE.
	GOOD LUCK TO YOU ALL!
...
def closet_2():
		...
		pdr_1 = randint(1, count3)
		pdr_2 = randint(1, count3)
		pdr_3 = randint(1, count3)

		input("""
		This room is a bright yellow, almost blinding some of the party (particularly """+party[pdr_3]['name']+""").
...
def closet_3():
	...
	input("""
	This room has glass walls and ceiling. Outside you can see fish swimming all around - are we at the bottom of a lake?
	...
	> ACTIVATED STRENGTH POTION ("""+str(count3)+""")
...
def closet_4():
	...
	print("""
	This room is relaxing and calm. A fireplace burning in the corner and cushions lined all around it.

	There is no chest in this room. The door slams shut and the party is attacked by....

	ALL THE BOOBS.

	"""+party[pdr_3]['name']+""" is in love.
	"""+party[pdr_1]['name']+""" doesn't want to hold back.

	Taped to a boob is a note. """+party[pdr_2]['name']+""" reads the note:

	IN CASE YOU DON'T SURVIVE THE NEXT TRIAL, HERE ARE SOME BOOBS TO ENJOY.

	LET'S CALL THIS YOUR SEVEN MINUTES OF HEAVEN. THE DOOR WILL OPEN IN SEVEN MINUTES.

	DO WHAT YOU WOULD LIKE UNTIL THEN.
	...
	input("""
	Now the party is all...relaxed...and the door opens. Time to continue our adventure!
	""")
...
def final_combat():
	...
	print("""
	"""+party[pdr_1]['name']+""" goes to the bottle in the middle of the room.

	They pick it up and the room starts to shake.

	Suddenly a loud voice speaks out of nowhere.

	"I hope you are ready for what is about to come.
	In order to leave this dungeon, you must defeat me.

	I hope you can win, but I am sure hungry..."
	""")
	...
	input("""
	Out of no where a dragon materializes. The dragon puts on a big smile and then it attacks!
	...
	while monster[1] >= 1:
		...
		print("You attacked with: "+str(char_roll))
		monst_roll=randint(1,6)
		print("The dragon attacks with: "+str(monst_roll))
		if char_roll+party[dic_num]['strength'] >= monst_roll+monster[0]:
	...
	input('The dragon stops attacking....')
...
def run_2():
	...
	print("""
	Bakeneko:
	You want to run away. That is just so sad...well I tricked you.
	You can't just leave your friend. It's all or none.

	Since you wanted to run. I say all.
...
def win_dragon():
	...
	print("""
	The dragon coughs out blood.
	'You all did well and have defeated me. You are the only party that has ever done that.

	When I am gone, a door will appear. You will be able to leave this dungeon and will be able to take any of the treasures you can carry.'

	The dragon disintegrates and appears a door.

	"""+party[pdr_1]['name']+""" walks up to the door and opens it.

	The rest of the party packs up what they can of gold.
	...
	print("""
	Registrar:
	Well this hasn't happened before. I'm...er...glad...you made it out alive.

	Congratulations.

	Come back soon if you want to try your luck again.
